import {MAKE_MOVE, START_GAME, MAIN_MENU, GAME_OVER} from "../actions/actionTypes.js";
...
function gameStatusReducer(previousState = {}, action){
    switch(action.type){
        case START_GAME:
            return {...previousState, currentView: "in-game"};
        case MAIN_MENU:
            return defaultGameStatus;
        case GAME_OVER:
            return {...previousState, currentView: "game-over",
